<script>
	...
	async function handleChangePassword() {
		...
		if (updateError) {
			errorMessage = 'Fehler beim Ändern des Passworts: ' + updateError.message;
			loading = false;
			return;
		}

		// User Metadata aktualisieren (Flag entfernen)
		...
		if (metadataError) {
			console.error('Fehler beim Aktualisieren der Metadata:', metadataError);
		}
...
<style>
	...
	:global(.dark) .change-password-container {
